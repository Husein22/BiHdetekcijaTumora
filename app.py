...
class TumorDetectorr:
    ...
    def get_class_name(self, class_no):
        if class_no == 0:
            return "NE.Nije pronađen tumor na mozgu"
        elif class_no == 1:
            return "DA.Pronađen je tumor na mozgu"


app=Flask(__name__)
tumor_detector = TumorDetectorr("TumorMozga10EpochsCategotical.h5")
...
def login():
    ...
    if request.method=="POST":
        ...
        if pacijent or doktor or sestra:
            ...
            msg="Ime ili sifra trenutno nisu pronađeni u našoj bazi podataka.Molimo pokusajte kasnije"
